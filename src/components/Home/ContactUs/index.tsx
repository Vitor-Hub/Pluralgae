...
const ContactUs = (props: IContactUs) => {
  ...
  const [isEmailSent, setIsEmailSent] = useState<EIsEmailSent>(
    EIsEmailSent.Empty
  );
        ...
        <div className="inputs">
          ...
          >
            ...
            <InputBase
              ...
              id="name"
              onChange={(e) =>
                setEmailData({ ...emailData, name: e.currentTarget.value })
              }
            ...
            <TextField
              ...
              id="field"
              onChange={(e) =>
                setEmailData({ ...emailData, text: e.currentTarget.value })
              }
