...
const Advantages = (props: IAdvantages) => {
      ...
      <div ref={AdvantagesRef} className="Advantages">
        <div className="mainDiv">
          <div className="leftContent">
            <h1 className="title">
              Por que adicionar a spirulina pluralgae no seu dia a dia?
            </h1>
            <div className="infos">
              <div className="infosTop">
                <div className="strength">
                  ...
                  <h3>
                    Contribui para melhorar a força e resistência muscular e
                ...
                <div className="cholesterol">
                  ...
                  <h3>
                    Auxilia na redução do colesterol, contribui para a redução
                    da pressão arterial e ajuda a controlar o açúcar no sangue
                  </h3>
                </div>
              </div>
              <div className="infosBottom">
                <div className="antioxidants">
                  ...
                  <h3>
                    Possui antioxidantes e propriedades anti-inflamatórias e
                    anti-câncer
                  </h3>
                </div>
                <div className="safe">
                  ...
                  <h3>
                    A Pluralgae é uma empresa comprometida com uma produção de
