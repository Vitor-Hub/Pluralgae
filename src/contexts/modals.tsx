...
export const ModalControlContext = createContext<IModalControlContext>({} as IModalControlContext);
...
export const ModalControlProvider: React.FC<IProps> = ({children}) => {
  ...
  return(
      <ModalControlContext.Provider 
        value={{ 
          isOpenSignUpModal, isOpenSignInModal, setIsOpenSignInModal, setIsOpenSignUpModal
        }}
      >
          {children}
      </ModalControlContext.Provider>
